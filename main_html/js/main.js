        ...
        .then(function(myJson) {
                    ...
                    for(let i =0;i<myJson[0].Comment_data.length;i++)
                    {
                        ...
                        <div class="activity__message_detail_out">
                            <div class="activity__message_detail">
                                ...
                                <div class="activity__question_time">${myJson[0].Comment_data[i].Comment_time.replace('T',' ').substring(0,19)}</div>
            ...
            function function_add_person_out()
            {
               ...
               else
               {
                    ...
                    // console.log(myJson[0].PostActicicy_data[0].Poster_id)
                    // console.log(myJson[0].PostActicicy_data[0].Poster_id == sessionStorage.getItem('Customer_id'))
                    for(let i =0;i<myJson[0].Attend_data.length;i++)
                    {
                        str +=
                        `
            ...
            else
            {
                for(let i = 0;i<myJson[0].Attend_data.length;i++)
                {
                    list_joiner_id.push(myJson[0].Attend_data[i].Joiner_id) 
                }
            }
            ...
            <div class="activity_content_box">
                ...
                <div class="activity_title_box">
                    ...
                    <!-- ${(new Date(myJson[0].PostActicicy_data[0].End_time.replace('T',' '))).getTime()>Date.now() && (new Date(myJson[0].PostActicicy_data[0].Start_time.replace('T',' '))).getTime()<Date.now() && myJson[0].PostActicicy_data[0].Poster_id == sessionStorage.getItem('Customer_id')?'<div class="add_activity" id="add_activity"><i class="fa-solid fa-plus"></i>我要報名</div>':''} -->
                </div>
                ...
                ${(new Date(myJson[0].PostActicicy_data[0].End_time.replace('T',' '))).getTime()>Date.now()&&(new Date(myJson[0].PostActicicy_data[0].Start_time.replace('T',' '))).getTime()<Date.now()&&sessionStorage.getItem('Customer_id') != myJson[0].PostActicicy_data[0].Poster_id&&!(list_joiner_id.includes(parseInt(sessionStorage.getItem('Customer_id'))))?'<div class="add_activity" id="add_activity"><i class="fa-solid fa-plus"></i>我要報名</div>':''}
